...
do
	...
	parallel -j${threads_num} \
		python3 /home/yangxr/projects/learned_dram/hot_dist/hot_trace/utils/plot_hot_set_diff.py \
		--type ::: ${type_list[@]} \
		::: --period ::: ${period_list[@]} \
		::: ${benchname}" > log/all_hot_set_diff.log

	parallel -j${threads_num} \
		python3 /home/yangxr/projects/learned_dram/hot_dist/hot_trace/utils/plot_hot_set_diff.py \
		--type ::: ${type_list[@]} \
		::: --period ::: ${period_list[@]} \
		::: ${benchname} 2>&1 >> log/all_hot_set_diff.log
